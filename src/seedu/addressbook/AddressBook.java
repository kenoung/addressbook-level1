...
public class AddressBook {
    ...
    private static final String COMMAND_REGEX_WHITESPACE = "\\s+";
    ...
    private static String[] splitCommandWordAndArgs(String rawUserInput) {
        final String[] split =  rawUserInput.trim().split(COMMAND_REGEX_WHITESPACE, 2);
    ...
    private static ArrayList<String> splitByWhitespace(String toSplit) {
        return new ArrayList<>(Arrays.asList(toSplit.trim().split(COMMAND_REGEX_WHITESPACE)));
    }
