...
public class AddressBook {
    ...
    /* We use a HashMap to store details of a person. Below are the keys to 
     ...
     */
    private static String getMessageForPersonsDisplayedSummary(ArrayList<HashMap<String, String>> personsFound) {
    ...
    */
     ...
     */
    private static String getPhoneFromPerson(HashMap<String, String> addedPerson) {
        return addedPerson.get(PERSON_PROPERTY_PHONE);
    }
